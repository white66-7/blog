    ...
    <div class="wrapper">
      ...
      <div class="wallContainer">
        ...
        >
          ...
          <line stroke-width="6" stroke="#7C7C7C" y2="85" x2="400" y1="85" x1="100" />
          <line stroke-width="6" stroke="#7C7C7C" y2="122" x2="375" y1="122" x1="125" />
          <line stroke-width="6" stroke="#7C7C7C" y2="43" x2="500" y1="43" />
          ...
          <line stroke-width="6" stroke="#7C7C7C" y2="43" x2="153" y1="84.0122" x1="153" />
          <line stroke-width="6" stroke="#7C7C7C" y2="43" x2="228" y1="84.0122" x1="228" />
          <line stroke-width="6" stroke="#7C7C7C" y2="43" x2="303" y1="84.0122" x1="303" />
          <line stroke-width="6" stroke="#7C7C7C" y2="43" x2="378" y1="84.0122" x1="378" />
          <line stroke-width="6" stroke="#7C7C7C" y2="84" x2="192" y1="125.012" x1="192" />
          <line stroke-width="6" stroke="#7C7C7C" y2="84" x2="267" y1="125.012" x1="267" />
          <line stroke-width="6" stroke="#7C7C7C" y2="84" x2="342" y1="125.012" x1="342" />
        </svg>
      </div>
    </div>
  </div>
...
.loader {
  ...
  margin: 16px auto 8px;  /* 增加上下边距，适应列表布局 */
}
.wrapper {
  width: fit-content;
  height: fit-content;
