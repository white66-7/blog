...
@media (max-width: 768px) {
  ...
  .large-polaroid {
    width: auto;
    max-width: 96vw; /* 允许相框最宽占满手机屏幕 96% */
    padding: 8px 8px 28px 8px; /* 极窄的白色边距 */
  }
  ...
  .real-image-large {
    /* 核心魔法：强制图片放大 */
    width: 2000px;     /* 给一个巨大的初始宽度，强迫图片往外撑 */
    max-width: 100%;   /* 撑到相框边界(96vw)时立刻停下，横图完美 */
    max-height: 75vh;  /* 高度撑到屏幕 75% 时立刻停下，竖图完美 */
    object-fit: contain;
  }
