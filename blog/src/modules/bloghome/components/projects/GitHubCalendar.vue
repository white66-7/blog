    ...
    <div class="content-side">
      ...
      <div class="stats-card">
        <div class="stats-grid">
          <div class="stat-box">
            <div class="stat-num">{{ totalContributions }}</div>
            <div class="stat-label">贡献总数</div>
          </div>
          <div class="stat-box">
      ...
      <div class="wall-wrapper">
        <div class="section-label wall-title">我的贡献墙</div>
        <div class="contrib-container">
          <!-- 骨架屏 -->
          <div v-if="!hasData" class="skeleton-grid">
...
@media (max-width: 768px) {
  ...
  .intro-side, .content-side {
    flex: none;
    width: 100%;
  }
}

/* ===== 复用作品集的 section-label ===== */
.section-label {
...
.l1 { background: rgba(0, 71, 255, 0.2); }
.l2 { background: rgba(0, 71, 255, 0.4); }
.l3 { background: rgba(0, 71, 255, 0.65); }
.l4 { background: rgba(0, 71, 255, 0.9); }
