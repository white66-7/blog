<template>
  <div class="info-card">
    ...
    <!-- 社交图标 -->
    <ul class="wrapper">
      <a href="https://github.com/yourname" target="_blank" class="icon github">
      ...
      <a href="https://space.bilibili.com/yourid" target="_blank" class="icon bilibili">
      ...
      <a href="https://wpa.qq.com/msgrd?v=3&uin=yourqq&site=qq&menu=yes" target="_blank" class="icon qq">
      ...
      <a href="#" class="icon wechat" @click.prevent="showWechat = true">
    ...
    <!-- 微信弹窗 -->
    <div v-if="showWechat" class="wechat-modal" @click="showWechat = false">
      <div class="wechat-content" @click.stop>
        <p>微信号：yourwechat</p>
        <button @click="showWechat = false">关闭</button>
      </div>
    </div>
  </div>
</template>
...
.wrapper .bilibili:hover .tooltip,
.wrapper .bilibili:hover .tooltip::before {
  background: #00a1d6;
  color: #fff;
}
